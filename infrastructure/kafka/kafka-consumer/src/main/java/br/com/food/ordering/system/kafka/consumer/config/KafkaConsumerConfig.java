package br.com.food.ordering.system.kafka.consumer.config;

import br.com.food.ordering.system.kafka.config.data.KafkaConfigData;
import br.com.food.ordering.system.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, kafkaConsumerConfigData.getMaxPoolIntervalMs());
