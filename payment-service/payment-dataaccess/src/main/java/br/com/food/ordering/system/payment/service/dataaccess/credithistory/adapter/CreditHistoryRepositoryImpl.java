package br.com.food.ordering.system.payment.service.dataaccess.credithistory.adapter;
...
import br.com.food.ordering.system.payment.service.dataaccess.credithistory.mapper.CreditHistoryDataAccessMapper;
import br.com.food.ordering.system.payment.service.dataaccess.credithistory.repository.CreditHistoryJpaRepository;
    ...
    public Optional<List<CreditHistory>> findByCustomerId(CustomerId customerId) {
        ...
        return creditHistory
                .map(creditHistoryList ->
                        creditHistoryList.stream().map(creditHistoryDataAccessMapper::creditHistoryEntityToCreditHistory)
