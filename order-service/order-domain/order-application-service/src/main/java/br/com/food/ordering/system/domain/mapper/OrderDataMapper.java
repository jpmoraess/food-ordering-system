package br.com.food.ordering.system.domain.mapper;
...
public class OrderDataMapper {
    ...
    private List<br.com.food.ordering.system.domain.entity.OrderItem> orderItemsToOrderItemEntities(
            List<OrderItem> orderItems) {
        return orderItems.stream().map(orderItem -> br.com.food.ordering.system.domain.entity.OrderItem.builder()
