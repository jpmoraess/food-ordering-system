package br.com.food.ordering.system.order.service.domain.outbox.scheduler.payment;
...
import br.com.food.ordering.system.order.service.domain.ports.output.repository.PaymentOutboxRepository;
...
import static br.com.food.ordering.system.saga.order.SagaConstants.ORDER_SAGA_NAME;
...
public class PaymentOutboxHelper {
    ...
    public Optional<List<OrderPaymentOutboxMessage>> getPaymentOutboxMessageByOutboxStatusAndSagaStatus(
        ...
        return paymentOutboxRepository
                .findByTypeAndOutboxStatusAndSagaStatus(ORDER_SAGA_NAME, outboxStatus, sagaStatus);
    }

    @Transactional(readOnly = true)
    public Optional<OrderPaymentOutboxMessage> getPaymentOutboxMessageBySagaIdAndStatus(UUID sagaId,
